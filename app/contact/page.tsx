      ...
      <main className="min-h-screen bg-brand-black text-white pt-20">
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl lg:text-6xl font-bold text-white font-space-grotesk mb-8">
              CONTACT
            </h1>
            ...
            <div className="grid md:grid-cols-2 gap-8 text-left">
              ...
              <div className="bg-gray-900 p-8 rounded-lg">
                ...
                <a 
                  href="https://wa.me/+919100333800?text=Hi! I'd like to discuss a prosthetic makeup project."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-brand-orange hover:underline flex items-center"
                >
